...
router.get('/', authorize('ADMIN', 'PRINCIPAL', 'TEACHER', 'PARENT'), studentController.getAllStudents);
router.get('/class/:classId', authorize('ADMIN', 'PRINCIPAL', 'TEACHER'), studentController.getStudentsByClass);
router.get('/:id', requireOwnership('id', ['ADMIN', 'PRINCIPAL', 'TEACHER', 'PARENT']), studentController.getStudentById);
...
router.get('/:id/attendance', requireOwnership('id', ['ADMIN', 'PRINCIPAL', 'TEACHER', 'PARENT']), studentController.getStudentAttendance);
router.get('/:id/fees', requireOwnership('id', ['ADMIN', 'PRINCIPAL', 'ACCOUNTANT', 'PARENT']), studentController.getStudentFees);
router.get('/:id/results', requireOwnership('id', ['ADMIN', 'PRINCIPAL', 'TEACHER', 'PARENT']), studentController.getStudentResults);
